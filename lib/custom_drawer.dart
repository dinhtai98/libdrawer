library drawercustom;

import 'package:customdrawer/navigation_menu_item.dart';
...
class _MultiLevelDrawerState extends State<MultiLevelDrawer> {
  ...
  List<NavigationMenuItem> drawerItems = [];
  double itemSize = 0;
                    ...
                    Positioned(
                        ...
                        child: CustomPaint(
                          ...
                          painter: _ArrowPainter(
                              arrowColor: widget.subMenuBackgroundColor ?? Colors.accents),
                        ))
                  ],
                )),
          ],
                ...
                Container(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      NavigationMenuItem item = drawerItems[index];
                      return _MLChoiceItem(
